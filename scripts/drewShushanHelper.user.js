// ==UserScript==
// @name        Drew and Shushan Helper
// @namespace   Marascripts
// @description Does Drew and Shushan, and prompts when item is missing.
// @author      marascripts
// @version     1.0.0
...
// @downloadURL https://raw.githubusercontent.com/marascript/userscripts/master/scripts/drewShushanHelper.user.js
...
/**
 * Completes Drew/Shushan quests and accepts the next one.
 * If there are missing items, it will show an alert, and then it is up to the user to get them.
 * 
 * TODO: Account for max amount of socks on Shushan quests
 */
