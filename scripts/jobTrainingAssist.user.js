...
if (actors.includes(petId)) {
    updateActor()
}
if (architects.includes(petId)) {
    updateArchitect()
}
if (astronauts.includes(petId)) {
    updateAstronaut()
}
if (athletes.includes(petId)) {
    updateAthlete()
}
if (bankers.includes(petId)) {
    updateBanker()
}
if (entrepeneurs.includes(petId)) {
    updateEntrepeneur()
}
if (chefs.includes(petId)) {
    updateChef()
}
if (clowns.includes(petId)) {
    updateClown()
}
if (doctors.includes(petId)) {
    updateDoctor()
}
if (fireFighters.includes(petId)) {
    updateFireFighter()
}
if (hackers.includes(petId)) {
    updateHacker()
}
if (journalists.includes(petId)) {
    updateJournalist()
}
if (mechanics.includes(petId)) {
    updateMechanic()
}
if (models.includes(petId)) {
    updateModel()
}
if (police.includes(petId)) {
    updatePoliceOfficer()
}
if (politicians.includes(petId)) {
    updatePolitician()
}
if (popStars.includes(petId)) {
    updatePopStar()
}
if (programmers.includes(petId)) {
    updateProgrammer()
}
if (scientists.includes(petId)) {
    updateScientist()
}
if (soldiers.includes(petId)) {
    updateSoldier()
}
if (spys.includes(petId)) {
    updateSpy()
}
if (teachers.includes(petId)) {
    updateTeacher()
}
if (thieves.includes(petId)) {
    updateThief()
}
if (vets.includes(petId)) {
    updateVterinarian()
}
